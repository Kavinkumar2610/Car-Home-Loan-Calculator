...
**Live:** <https://kavinkumar2610.github.io/Car-Home-Loan-Calculator/> — just open in any browser. No install, no dependencies.

**Offline:** open [`index.html`](index.html) directly — works with no internet at all.
